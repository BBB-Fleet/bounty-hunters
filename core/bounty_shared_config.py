...
MASTER_BUG_BOUNTY_SOURCES = {
    "TIER_1_FULLY_OPEN": [
        {"name": "disclose.io", "url": "https://disclose.io", "type": "Global VDP & Bug Bounty Directory", },
        {"name": "Open Bug Bounty", "url": "https://openbugbounty.org", "type": "Fully Public Platform", },
        {"name": "HuntBug", "url": "https://huntbug.com", "type": "Public Program Directory", },
        {"name": "BountiesAlert", "url": "https://bountiesalert.com", "type": "Public Program Feed", }
    ],
    "TIER_2_PUBLIC_LISTS": [
        {"name": "Bugcrowd Public", "url": "https://bugcrowd.com/programs", "type": "Public Program List" },
        {"name": "HackerOne Directory", "url": "https://hackerone.com/directory/programs", "type": "Public Directory", }
    ],
    "TIER_3_BROADCAST_FEEDS": [
        {"name": "disclose.io Twitter Feed", "url": "https://twitter.com/disclose_io", "type": "Social Broadcast Alert", },
        {"name": "HuntBug Discord Feed", "url": "https://discord.gg/huntbug", "type": "Webhook Feed", },
        {"name": "Open Bug Bounty Telegram", "url": "https://t.me/openbugbounty", "type": "Public Alert Feed", }
    ],
    "TIER_4_WEB3_PLATFORMS": [
        {"name": "Immunefi", "url": "https://immunefi.com", "type": "Web3 Bug Bounties", },
        {"name": "Code4rena", "url": "https://code4rena.com", "type": "Audit Contests", },
        {"name": "Sherlock", "url": "https://sherlock.xyz", "type": "Web3 Security Contests", }
    ]
}
...
# === Fleet 2: 17 Daily Runs Schedule, 17 Real Vulnerability Runs) ===
TOTAL_DAILY_RUNS = 17
REAL_BOUNTY_RUNS_PER_DAY = 17
CYCLE_INTERVAL_MINUTES = 85
REAL_BOUNTY_RUNS_PER_DAY = TOTAL_DAILY_RUNS
